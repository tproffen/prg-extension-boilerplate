...
const MODAL_TM_MODEL = 'tmModelModal'; //'questionModal';
...
const openModelModal = function () {
    return openModal(MODAL_TM_MODEL);
};
...
const closeModelModal = function () {
    return closeModal(MODAL_TM_MODEL);
};
export {
    reducer as default,
